...
SEL4_OS_PATH            ?= $(ROOT)/sel4
SEL4_LOADER_PATH            ?= $(ROOT)/tee_loader
SEL4_OS_BIN             ?=  $(ROOT)/tee_loader/out/sel4_packed.bin
...
.PHONY: sel4_packed
sel4_packed : sel4
	rm -rf $(SEL4_LOADER_PATH)/out
	$(MAKE) -C $(SEL4_LOADER_PATH) LOADER_PATH=$(SEL4_LOADER_PATH) CROSS_COMPILE=$(CROSS_COMPILE_S_USER) all

sel4:
	rm -rf $(SEL4_OS_PATH)/out
	$(MAKE) -C $(SEL4_OS_PATH) SEL4_PATH=$(SEL4_OS_PATH) CROSS_COMPILE=$(CROSS_COMPILE_S_USER) all
